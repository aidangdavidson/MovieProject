...
public class ViewAllListsServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<MovieListDetails> deets = slh.getLists();
		request.setAttribute("allLists", deets);
		...
		getServletContext().getRequestDispatcher("/movie-list-by-studio.jsp").forward(request, response);
